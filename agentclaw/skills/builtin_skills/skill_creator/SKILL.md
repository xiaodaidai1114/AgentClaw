---
name: skill_creator
description: Create or modify AgentClaw skill packages. Use when changing skill scope, trigger descriptions, bundled references, scripts, assets, metadata, packaging, documentation, validation, or distribution.
---
...
3. Initialize the skill (run `python scripts/init_skill.py`)
4. Edit the skill (implement resources and write SKILL.md)
5. Package the skill (run `python scripts/package_skill.py`)
...
When creating a new skill from scratch, always run the `init_skill.py` script through Python. This is the most reliable cross-platform invocation pattern and works consistently on Linux, macOS, and Windows.
