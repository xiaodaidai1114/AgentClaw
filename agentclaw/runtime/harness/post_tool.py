...
HARNESS_POST_TOOL_CONTROLLER_PROMPT = (
    ...
    "Decision policy:\n"
    "- Prefer finish when the latest tool results are enough to answer or complete the user's request; the runtime will generate the final answer in a separate no-tools pass.\n"
    ...
    "- continue only when a specific missing fact/tool result is still required. Do not continue just to polish, summarize again, or search for optional improvements.\n"
