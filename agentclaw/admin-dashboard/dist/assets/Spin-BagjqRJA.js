import{aa as S,C as h,z as p,bV as C,D as f,G as x,x as r,bT as T,aW as $,H as k,ae as v,an as w,b4 as O,n as m,r as R,bW as j,bb as B,ap as N,bO as P}from"./index-DSKScKLh.js";function V(e){const{opacityDisabled:a,heightTiny:t,heightSmall:s,heightMedium:l,heightLarge:n,heightHuge:c,primaryColor:o,fontSize:i}=e;return{fontSize:i,textColor:o,sizeTiny:t,sizeSmall:s,sizeMedium:l,sizeLarge:n,sizeHuge:c,color:o,opacitySpinning:a}}const W={common:S,self:V},H=h([h("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
