import{ac as S,C as h,z as p,bX as C,D as f,G as x,x as r,bV as T,aY as $,H as k,ag as v,ap as w,b6 as R,n as m,r as O,bY as j,bd as B,ar as N,bQ as P}from"./index-CQyTAGUL.js";function V(e){const{opacityDisabled:a,heightTiny:t,heightSmall:s,heightMedium:l,heightLarge:n,heightHuge:c,primaryColor:o,fontSize:i}=e;return{fontSize:i,textColor:o,sizeTiny:t,sizeSmall:s,sizeMedium:l,sizeLarge:n,sizeHuge:c,color:o,opacitySpinning:a}}const H={common:S,self:V},L=h([h("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
